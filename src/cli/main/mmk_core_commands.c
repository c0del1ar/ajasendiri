...
static const StdlibModuleSpec k_stdlib_modules[] = {
    ...
    {"numutil", STDLIB_TIER_OPTIONAL},
    {"stats", STDLIB_TIER_OPTIONAL},
    {"ranges", STDLIB_TIER_OPTIONAL},
    {"counter", STDLIB_TIER_OPTIONAL},
    {"csvutil", STDLIB_TIER_OPTIONAL},
    {"inimini", STDLIB_TIER_OPTIONAL},
    {"templ", STDLIB_TIER_OPTIONAL},
    {"guard", STDLIB_TIER_OPTIONAL},
    {"version", STDLIB_TIER_OPTIONAL},
    {"idgen", STDLIB_TIER_OPTIONAL},
    {"batch", STDLIB_TIER_OPTIONAL},
    {"iterutil", STDLIB_TIER_OPTIONAL},
    {"pairutil", STDLIB_TIER_OPTIONAL},
    {"logic", STDLIB_TIER_OPTIONAL},
    {"randpick", STDLIB_TIER_OPTIONAL},
    {"textscan", STDLIB_TIER_OPTIONAL},
    {"dedupe", STDLIB_TIER_OPTIONAL},
    {"codec", STDLIB_TIER_OPTIONAL},
    {"paginator", STDLIB_TIER_OPTIONAL},
    {"stopwatch", STDLIB_TIER_OPTIONAL},
};
